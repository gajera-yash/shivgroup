    ...
    <footer className="bg-[#F2F2EB] w-full pt-12 md:pt-16 lg:pt-24 pb-8 px-4 sm:px-6 md:px-12 lg:px-[135px]">
      <div className="max-w-[1920px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-5 items-start">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 md:grid-cols-2 gap-y-12 gap-x-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="font-body text-base text-black/80 font-medium leading-relaxed uppercase">
                MARKET#203 SAN FRANCISCO,<br /> CALIFORNIA (CA).
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <a href="mailto:shivgroup@yahoo.co.in" className="font-body text-base text-left lg:text-end text-black/80 font-bold hover:text-primary transition-colors">
                  shivgroup@yahoo.co.in
                </a>
                <a href="tel:+911234567890" className="font-body text-base text-left lg:text-end text-black/80 font-bold hover:text-primary transition-colors">
                  +91 123 456 7890
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 font-body text-sm font-bold text-black">
          <p>
            Copyright © 2026 SHIV GROUP, All rights reserved.
          </p>
          <div className="flex items-center gap-2">
            <Link to="/terms" className="hover:text-primary transition-colors">Terms of up</Link>
