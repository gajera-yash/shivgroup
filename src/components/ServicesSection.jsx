...
const services = [
  {
    ...
    path: '/services',
    image: '/shivgroup/images/img04.jpg',
  },
  {
  ...
  },
  {
    ...
    path: '/services',
    image: '/shivgroup/images/building.png',
  },
];
              ...
              <div className="flex-1 p-8 md:p-10 flex flex-col justify-between  md:border-b-0 md:border-r border-white/20">
                <ul className="space-y-5">
                  {activeService.subServices.map((sub, idx) => (
                    <li key={idx} className="flex items-start gap-4 text-white text-[15px] md:text-[17px] font-medium">
                      <img 
